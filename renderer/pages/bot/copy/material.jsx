  ...
  return (
    <React.Fragment>
      ...
      <div>
          ...
          <Accordion
            pageProps={
              <>
                ...
                <p>
                  Este robô fara a copia de material apenas para uma sala
                  desejada, e retornará o resultado na planilha, devidamente
                  organizado em colunas na aba "salascopia".
                </p>
                <ObsComponent/>
              </>
            }
        ...
        <Runner script="Main_copy_material.py"></Runner>
      </div>
    </React.Fragment>
  );
}